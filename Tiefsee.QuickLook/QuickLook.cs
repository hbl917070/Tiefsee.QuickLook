...
namespace Tiefsee {
    public class QuickLook {
        ...
        [DllImport("QuickLook.Native32.dll", EntryPoint = "Init", CallingConvention = CallingConvention.Cdecl)]
        private static extern void Init_32();

        [DllImport("QuickLook.Native32.dll", EntryPoint = "GetFocusedWindowType", CallingConvention = CallingConvention.Cdecl)]
        private static extern FocusedWindowType GetFocusedWindowTypeNative_32();

        [DllImport("QuickLook.Native32.dll", EntryPoint = "GetCurrentSelection", CallingConvention = CallingConvention.Cdecl)]
        private static extern void GetCurrentSelectionNative_32([MarshalAs(UnmanagedType.LPWStr)] StringBuilder sb);

        [DllImport("QuickLook.Native64.dll", EntryPoint = "Init", CallingConvention = CallingConvention.Cdecl)]
        private static extern void Init_64();

        [DllImport("QuickLook.Native64.dll", EntryPoint = "GetFocusedWindowType", CallingConvention = CallingConvention.Cdecl)]
        ...
        internal static FocusedWindowType GetFocusedWindowType() {
            try {
                return Is64Bit ? GetFocusedWindowTypeNative_64() : GetFocusedWindowTypeNative_32();
            } catch (Exception e) {
                Debug.WriteLine(e);
        ...
        /// <summary>
        /// 取得目前焦點檔案總管或桌面選取的檔案，如果焦點不在桌面或未選取檔案，則返回 ""
        /// </summary>
        /// <returns></returns>
